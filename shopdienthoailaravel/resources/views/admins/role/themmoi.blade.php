...
@section('content')
    <div class="content-fluid" style="margin: 10px">
        @include('admins.partials.content-header',['name'=>'Vai Trò Hệ Thống','key'=>'Thêm Mới'])
        <div class="content">
            <div class="container-fluid">
                <div class="row ">
                    <form action="{{route('roles.themmoi_gui')}}" method="post" enctype="multipart/form-data" style="width: 100%">
                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                       @foreach($i->permissionsChildrent  as $perChilder)
                                            ...
                                            <div class="card-body col-md-3 ">
                                                <h5 class="card-title ">
                                                    <label >
                                                        <input type="checkbox" name="permission_id[]" class="checkbox_childrent" value="{{ $perChilder->id}}">
                                                    </label>
                                                   {{ $perChilder->name}}
                                                </h5>
                                            </div>
